...
**Explanation:** I used a t-test to assess the data because the variance
must be estimated from the sample and the means of the data can be
assumed to follow a normal distribution. I found test statistics of
t~7~=-.22, which corresponds to a p-value of 0.83. Because this p-value
is greater than 0.05, I fail to reject the null hypothesis that the mean
